          ...
          >
            ...
            <HStack w={'full'} align={'baseline'}>
              ...
              <VStack align={'baseline'}>
                ...
                <Text fontSize={'sm'}> Choose 2(two) from the 8(eight) Fem Entity Introduction courses based on empowering and balancing your masculine and feminine energy. Includes any activity sheets and journaling pages that correspond to the course.  </Text>
              </VStack>
            </HStack>
